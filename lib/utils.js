...
/**
 * 判断一个值是否是 view on an ArrayBuffer
 *
 * @param {*} val The value to test
 *
...
/**
 * 判断一个值是否是 URLSearchParams object
 *
 * @param {*} val The value to test
 *
